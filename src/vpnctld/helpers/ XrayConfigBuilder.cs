...
{
    public object BuildVlessInbound(ServerData serverData, ClientsData clientsData)
    {
    ...
    public object BuildSocksInbound(ServerData serverData, ClientsData clientsData)
    {
    ...
    public object BuildShadowsocksInbound(ServerData serverData, ClientsData clientsData)
    {
        var clients = new List<object>();
