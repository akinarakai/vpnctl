...
public class Xray : IVpnService
{
    ...
    public bool GenerateRealityKeys(bool isForce)
    {
        ...
        if (!isForce)
            if (!VpnHelper.CanReplaceRealityKeys(server)) return false;
        ...
        var keys = FormatManager.ParseRealityKeyCommand(keyGenResult.Text);
    ...
    public VpnClientBase? CreateVlessClient(string name, bool needShortId)
    {
        ...
        var vlessUrl = FormatManager.GetVlessClientUrl(server, clientUuid, name, shortId, serverIp);
    ...
    public VpnClientBase? CreateSocksClient(string name, string? customPassword = null)
    {
        ...
        return new SocksClient
        {
            Name = name,
            Password = password,
            ConfigStr = FormatManager.GetSocksClientUrl(serverData, name, password, serverIp),
        };
    }
    ...
    public VpnClientBase? CreateSsClient(string name)
    {
        ...
        var ssUrl = FormatManager.GetShadowsocksClientUrl(serverData, name, password, method, serverIp);
